...
coverage was not reported. Keep this directory out of source control. Each run
...
Project dependency manifests and lockfiles are not edited by testdrive. Existing
package scripts and application hooks still run as usual. Tracer downloads require
network access. This release covers root projects and GitHub Actions onboarding;
