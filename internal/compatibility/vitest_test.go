...
func TestVitestFastAdapterIntegration(t *testing.T) {
...
`)
	t.Chdir(root)
	configureFramework(shellCommand(filepath.Join(root, "node_modules", ".bin", "vitest"), "--config", "vitest.unit.mjs"), "checks/**/*.check.js")
