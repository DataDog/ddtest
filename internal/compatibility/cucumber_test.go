...
func TestCucumberFastAdapterIntegration(t *testing.T) {
...
`,
	...
	// Tag filters apply during execution; discovery only reads file names.
	wantFiles := []string{"features/excluded.feature", "features/included.feature", "features/unassigned.feature"}
