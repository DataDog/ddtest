...
with `--command`; automatic detection does not override framework commands.

**typestack/class-validator**

```sh
ddtest testdrive --framework jest --yes --command 'npm test -- --runInBand'
```

**omichelsen/compare-versions**

```sh
ddtest testdrive --framework mocha --yes --command 'npm test'
```
